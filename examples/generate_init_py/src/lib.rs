...
#[gen_stub_pyclass]
#[pyclass(from_py_object, module = "generate_init_py._core")]
#[derive(Debug, Clone)]
pub struct A {
    x: usize,
}
...
#[gen_stub_pyclass]
#[pyclass(skip_from_py_object, module = "generate_init_py._core")]
#[derive(Debug, Clone)]
struct B {
    x: usize,
}
...
#[pyclass(from_py_object, module = "generate_init_py._core", frozen, eq)]
